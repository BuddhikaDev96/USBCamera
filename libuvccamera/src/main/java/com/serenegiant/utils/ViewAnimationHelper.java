...
public class ViewAnimationHelper {
    ...
    @SuppressLint({"NewApi"})
    public static void fadeIn(final View target, final long duration, final long startDelay, final ViewAnimationHelper.ViewAnimationListener listener) {
        if (target != null) {
    ...
    @SuppressLint({"NewApi"})
    public static void fadeOut(final View target, final long duration, final long startDelay, final ViewAnimationHelper.ViewAnimationListener listener) {
    ...
    @SuppressLint({"NewApi"})
    public static void zoomIn(final View target, final long duration, final long startDelay, final ViewAnimationHelper.ViewAnimationListener listener) {
        if (target != null) {
            target.postDelayed(new Runnable() {
                public void run() {
                    target.setVisibility(View.VISIBLE);
    ...
    @SuppressLint({"NewApi"})
    public static void zoomOut(final View target, final long duration, final long startDelay, final ViewAnimationHelper.ViewAnimationListener listener) {
        if (target != null) {
            target.postDelayed(new Runnable() {
                public void run() {
                    target.setVisibility(View.VISIBLE);
    ...
    private static void onAnimation(Animator animator, final int event) {
        if (animator instanceof ObjectAnimator) {
            ...
            final ViewAnimationHelper.ViewAnimationListener listener = (ViewAnimationHelper.ViewAnimationListener)target.getTag(id.anim_listener);
